...
{
    resize(850, 550);
    setWindowTitle(tr("dyor") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an dyor address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About dyor"), this);
    aboutAction->setToolTip(tr("Show information about dyor"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for dyor"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *dyor = appMenuBar->addMenu(tr("&dyor"));
    dyor->addAction(openRPCConsoleAction);
    dyor->addSeparator();
    dyor->addAction(aboutAction);
    dyor->addAction(aboutQtAction);
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("dyor client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("dyor client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to dyor network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid dyor address or malformed URI parameters."));
    }
