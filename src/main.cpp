...
const string strMessageMagic = "dyor Signed Message:\n";
                        ...
                        bool* pfMissingInputs)
{
...

    {
        ...
        // This is done last to dyor prevent CPU exhaustion denial-of-service attacks.
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
    ...
    if (nHeight <= 10)
        ...
        nSubsidy = (10 + rand) * COIN;
    else if (nHeight <= LAST_POW_BLOCK)
        nSubsidy = (10 + rand2) * COIN;
...
// introduced to dyor nodes establish a consistent view of the coin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // dyor: check proof-of-stake block signature
...
// dyor: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dyor", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Do Your Own Research!!!";
        CTransaction txNew;
        txNew.nTime = 1516596804;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1516596804;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1192954 : 1192954;
...
//        assert(block.hashMerkleRoot == uint256("0x"));
        assert(block.hashMerkleRoot == uint256("0x294b6a98b5eeb184be00af81462f6c3d3d4861c96c6f736b1a1c24fe86c75532"));
    ...
    string strPubKey = "04dce7036e6ea368c7a616c539b5972c96979fdadc0cc68668c93eac538e77947275b2a50679851abcf9064386dfdd8cd61c9e87ec9bee48e57efad70c53743413";
...
unsigned char pchMessageStart[4] = { 0x8e, 0x4c, 0xf1, 0x8d };
